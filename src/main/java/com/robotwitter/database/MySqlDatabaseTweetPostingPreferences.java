		...
		IDatabaseTweetPostingPreferences
{
	...
	{
		/** EMAIL of the user with these preferences. */
		EMAIL,
		
		/** Type of the preference (numbered/basic/custom). */
		TYPE,
		
		/** The custom prefix of the user. */
		PREFIX,
		
		/** The custom suffix of the user. */
		POSTFIX
	}
		...
		DBTweetPostingPreferences tweetPostingPreferences)
	{
		...
		if (tweetPostingPreferences.getPostingPreference() == TweetPostingPreferenceType.SUFFIX)
		{
		...
		creationQuery =
			String
				.format(
					...
					TweetPostingPreferenceType.SUFFIX.toString(),
