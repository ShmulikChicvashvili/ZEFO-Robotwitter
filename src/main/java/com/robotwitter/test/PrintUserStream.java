...
public final class PrintUserStream
{
	...
	private static final UserStreamListener listener = new UserStreamListener()
	{
		...
		{
			System.out.println("onBlock source:@"
		...
		public void onFollow(User source, User followedUser)
		{
			...
			System.out.println("rates before: " + source.getRateLimitStatus());
			System.out.println("favorites: " + source.getFavouritesCount());
			System.out.println("followers: " + source.getFollowersCount());
			System.out.println("following: " + source.getFriendsCount());
			System.out.println("location: " + source.getLocation());
			System.out.println("created at : " + source.getCreatedAt());
			System.out.println("rates after: " + source.getRateLimitStatus());
		}
