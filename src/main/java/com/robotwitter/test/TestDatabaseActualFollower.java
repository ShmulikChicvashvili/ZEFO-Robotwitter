...
public class TestDatabaseActualFollower {
	...
	public static final ArrayList<DBFollower> generateFollowersWithName(
		...
		ArrayList<DBFollower> list = new ArrayList<DBFollower>();
		for (int i = 0; i < amount; i++) {
			final DBFollower follower = new DBFollower(i + 100, name, "s" + i,
					"a", 10, 10, "l", 10, "l", false,
					Timestamp.valueOf("2005-09-23 10:10:10.0"), "p");
			list.add(follower);
		}
		return list;
	}
	...
	public static final ArrayList<DBFollower> generateFollowersWithScreenName(
			int amount, String screenName) {
		ArrayList<DBFollower> list = new ArrayList<DBFollower>();
		for (int i = 0; i < amount; i++) {
			final DBFollower follower = new DBFollower(i + 1000, "n" + i,
					screenName, "a", 10, 10, "l", 10, "l", false,
					Timestamp.valueOf("2005-09-23 10:10:10.0"), "p");
			list.add(follower);
		}
		return list;
	...
	public final void Test() {
		Timestamp joined1 = Timestamp.valueOf("2007-09-23 10:10:10.0");
		Timestamp joined2 = Timestamp.valueOf("2008-06-11 12:10:10.0");
		final DBFollower first = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, joined1, "twitter.com/random/profile");
		...
		final DBFollower second = new DBFollower(2, "random", "2ndary",
				"not as handsome and smart as random man", 888, 555, "Nowhere",
				2222, "Hebrew", false, joined2, "twitter.com/2ndary/profile");
	...
	public final void testInsertGet() {
		Timestamp joined = Timestamp.valueOf("2005-09-23 10:10:10.0");
		Timestamp joined2 = Timestamp.valueOf("2007-11-11 11:10:10.0");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(null));
		DBFollower badFollower = new DBFollower(-1, null, null, null, -1, -1,
				null, -1, null, false, null, null);
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(-1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, null, "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", null,
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan", null, 999, 666,
				"Everywhere", 6969, "Hebrew", false, joined,
				"twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", -1, 666, "Everywhere", 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, -1, "Everywhere", 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, null, 6969,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", -1,
				"Hebrew", false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				null, false, joined, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, null, "twitter.com/random/profile");
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		badFollower = new DBFollower(1, "random", "randomMan",
				"handsome and smart random man", 999, 666, "Everywhere", 6969,
				"Hebrew", false, joined, null);
		assertEquals(SqlError.INVALID_PARAMS, db.insert(badFollower));
		...
		final DBFollower okFollower = new DBFollower(666, "man", "manG",
				"some man", 12, 23, "somewhere", 2, "English", false, joined,
				"twitter.com/man/profile");
		final DBFollower secondFollower = new DBFollower(999, "2ndman",
				"2manG", "2nd man", 55, 66, "2nd place", 1, "Chinese", false,
				joined2, "twitter.com/man/profile");
	...
	public final void testGetsUpdateDelete() {
		final DBFollower mainUser = new DBFollower(123456789, "man", "manG",
				"some man", 9999, 9999, "somewhere", 9999, "English", false,
				Timestamp.valueOf("2010-10-10 10:10:10.0"),
				"twitter.com/man/profile");
		assertEquals(SqlError.SUCCESS, db.insert(mainUser));

		final ArrayList<DBFollower> nameFollowers = generateFollowersWithName(
				100, "Yossi");
		final ArrayList<DBFollower> screenNameFollowers = generateFollowersWithScreenName(
				100, "theYossi");
		final ArrayList<DBFollower> updatedFollowers = generateFollowersWithName(
				100, "Menahem");
		...
		for (DBFollower follower : nameFollowers) {
			assertEquals(SqlError.DOES_NOT_EXIST, db.update(follower));
			assertEquals(SqlError.DOES_NOT_EXIST,
		...
		final ArrayList<DBFollower> followerScreenNames = db
				.getByScreenName("theYossi");
		...
		final ArrayList<DBFollower> previousNameFollowers = db
				.getByName("Yossi");
