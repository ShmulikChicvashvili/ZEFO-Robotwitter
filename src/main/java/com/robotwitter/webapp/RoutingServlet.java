...
/**
 * Redirects HTTP requests to the server based on the user's browser.
 *
...
public class RoutingServlet extends HttpServlet
{
	...
	/**
	 * Checks if is the given HttpServletRequest comes from a mobile-browser.
	 *
	 * @param request
	 *            the HTTP request to the servlet
	 *
	 * @return true, if comes from a mobile-browser
	 */
