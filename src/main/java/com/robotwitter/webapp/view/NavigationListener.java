 ...
 * logged in.
 */
public class NavigationListener implements ViewChangeListener
{
	
	@Override
	public final void afterViewChange(ViewChangeEvent event)
	{
		// Retrieve needed objects
		Navigator navigator = event.getNavigator();
		AbstractUI ui = (AbstractUI) navigator.getUI();
	...
	@Override
	public final boolean beforeViewChange(ViewChangeEvent event)
	{
		// Retrieve needed objects
		Navigator navigator = event.getNavigator();
		AbstractUI ui = (AbstractUI) navigator.getUI();
