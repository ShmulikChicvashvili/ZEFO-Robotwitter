...
public class UserSession implements IUserSession
{
		...
		IAccountController accountController)
	{
		...
		isSigned = false;
		observingTwitterAccountChange = new ConcurrentLinkedQueue<>();
	...
	/** The set of observing component for an active Twitter Account change. */
	private Collection<RobotwitterCustomComponent> observingTwitterAccountChange;
