...
public class DashboardView extends AbstractView
{
		...
		IDashboardController controller)
	{
		...
		this.controller.setUser(getUserSession()
	...
	private HorizontalLayout createAccountsComponent()
	{
		...
		accountsComponent.setSpacing(!isMobile());
	...
	private Component createInformationComponent()
	{
		FollowersAmountOverview followersAmountOverview =
			new FollowersAmountOverview(messages, true);
		...
		if (isMobile())
		{
			// TODO add the stats to mobile browsers too (too lazy now)
			layout = new VerticalLayout(followersAmountOverview);
		} else
		{
			layout = new VerticalLayout(followersAmountOverview, stats);
		}
	...
	private void updateActiveTwitterAccountComponent()
	{
		...
		ConnectedAccountInfo accountInformation =
			controller.getAccountInfo(getUserSession()
				.getAccountController()
	...
	private static final String MOBILE_STYLENAME = "DashboardView-mobile";
