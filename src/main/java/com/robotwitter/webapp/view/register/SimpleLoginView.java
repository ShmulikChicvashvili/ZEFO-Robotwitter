		...
		Button.ClickListener
{
			...
			AbstractValidator<String>
	{
		...
		protected boolean isValidValue(String value)
		{
			...
			//
			if (value != null
				&& (value.length() < 8 || !value.matches(".*\\d.*"))) { return false; }
			return true;
		}
	 ...
	 * 
	 */
	private void handleLoginClick(ClickEvent event)
	{
	 ...
	 * 
	 */
	private void handleRegisterClick(ClickEvent event)
	{
		getUI().getNavigator().navigateTo(SimpleRegisterView.NAME);//
	}
}
